  ...
  try {
    ...
    try {
      ...
      if (create_invoice) {
        ...
        console.log('Kết quả tạo hóa đơn:', insertInvoiceResult);
      }
      ...
      if (create_checkout) {
        ...
        console.log('Kết quả tạo checkout:', insertCheckoutResult);
      }
  ...
  try {
    ...
    if (decodedData.embed_data) {
      try {
        ...
        //   [bookingId]
        // );
        // if (!booking || !ctbk) throw new Error('Thiếu dữ liệu để tạo vé');
